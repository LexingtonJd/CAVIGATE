...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        # training config
        self.parser.add_argument("--lr", type=float, default=2.0e-4, help="learning rate")
        self.parser.add_argument("--lr_warmup_proportion", type=float, default=0.005,
                                 help="Proportion of training to perform linear learning rate warmup.")
        self.parser.add_argument("--wd", type=float, default=0.01, help="weight decay")
        self.parser.add_argument("--n_epoch", type=int, default=200, help="number of epochs to run")
        ...
        self.parser.add_argument("--hard_negative_start_epoch", type=int, default=-1,
        ...
        self.parser.add_argument("--q_feat_size", type=int, default=512, help="feature dim for query feature")
        ...
        self.parser.add_argument("--C_hidden_size", type=int, default=384)
        self.parser.add_argument("--n_heads", type=int, default=4)
        self.parser.add_argument("--input_drop", type=float, default=0.2, help="Applied to all inputs")
        self.parser.add_argument("--drop", type=float, default=0.2, help="Applied to all other layers")
        ...
        self.parser.add_argument('--double_branch', type=str2bool, default=True)
        self.parser.add_argument('--video_level_branch', type=str2bool, default=True)
        self.parser.add_argument('--use_clip', type=str2bool, default=True)
