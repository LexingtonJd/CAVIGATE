...
import math
import numpy as np
from method.attention import MultiheadAttention
...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=384, nhead=8, num_queries=2, num_encoder_layers=6,
    ...
    def forward(self, src, mask, query_embed, pos_embed=None, video_length=None):
        """
        Args:
            src: (batch_size, L, d)
            mask: (batch_size, L)
        ...
        if pos_embed is None:
            pos_embed = torch.zeros(bs, l, d, device=src.device, dtype=src.dtype)
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None, return_intermediate=False,
                 d_model=384, query_dim=2, keep_query_pos=False, query_scale_type='cond_elewise',
