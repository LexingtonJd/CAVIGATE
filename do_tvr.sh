...
model_name=DLDKD
margin=0.1
#root_path=/media/jianglab/experiment/ZQ/DL-DKD/data
...
do
  CUDA_VISIBLE_DEVICES=0 python method/train.py  --collection $collection --visual_feature $visual_feature \
                      ...
                      --use_clip $use_clip --double_branch $double_branch --video_level_branch $video_level_branch\
